...
var Wrapper = _styledComponents2.default.span(_templateObject, function (props) {
    ...
    return props.theme.mediaMinWidth;
}, function (props) {
...
var Box = _styledComponents2.default.div(_templateObject, function (props) {
    var i = props.index % props.theme.bgCount;
...
var TextBtn = _styledComponents2.default.button(_templateObject3, function (props) {
    ...
    return props.bgColor ? props.bgColor : props.theme.neutral;
});
...
var _DriveInterface = __webpack_require__(17);

var _ClassInterface = __webpack_require__(38);
...
var _Submit = __webpack_require__(94);
    ...
    function Game(props) {
        ...
        _this.state = {
            ...
            tools: {
                ...
                views: _extends({}, GameLibs.views, {
                    styled: _styledComponents2.default
                }),
                utils: _extends({}, GameLibs.utilities),
                simulation: _extends({}, GameLibs.simulation),
                settings: _extends({}, _this.props.settings),
                createReport: _this.submitAssignment,
                createAssignment: _this.submitAssignment,
    ...
    _createClass(Game, [{
        ...
        value: function importGraph() {
            ...
            (0, _universalImport3.default)({
                ...
                load: function load() {
                    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 42)), (0, _importCss3.default)('recharts', {
    ...
    if (elements) {
        ...
        elements.map(function (e) {
            ...
            if (e.score) {
                ...
                var charCount = 189;
                var score = e.score;
                var ratio = Math.abs(score * charCount);
                var filled = '';
                var empty = '';
                tag = 'div';
...
//chartId:1216131842
var createReport = exports.createReport = function createReport(game, name, elements) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        if (name && elements) {
            createAFile('application/vnd.google-apps.document', 'text/html', name, 'webViewLink, webContentLink', { gamegrade: '80' }).then(function (r) {
                console.log('create file result', r);
...
var base = {
    ...
    /*
        ...
        neutralL: '#212121',
    */
};var night = exports.night = _extends({}, base, {
    neutral: '#121212',
    neutralL: '#212121',
    neutralD: 'black',
    text: '#CCCCCC',
...
var day = exports.day = _extends({}, base, {
    neutral: '#F9FFBF',
    neutralL: 'white',
    neutralD: '#FFDCA8',
    text: '#525252',
...
var _Tags = __webpack_require__(28);
...
var _PostItem = __webpack_require__(68);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.props.items.map(function (p) {
                        return _react2.default.createElement(
                            'span',
                            { className: 'anim-child', style: { width: '100%' }, __source: {
                                    fileName: _jsxFileName,
                                    lineNumber: 62
                                }
                            },
...
var A = _styledComponents2.default.span(_templateObject2);
...
var _Sizer = __webpack_require__(33);
...
var _reactHelmet = __webpack_require__(82);
...
module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 32 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"
...
var _baselineVideogame_asset24px = __webpack_require__(36);
...
var Trans = function (_React$Component) {
    ...
    _createClass(Trans, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                Fade,
                { duration: this.state.duration, __source: {
                        fileName: _jsxFileName,
                        lineNumber: 16
                    }
                },
                _react2.default.createElement(
                    _reactAddonsCssTransitionGroup2.default,
                    {
                        ...
                        transitionLeaveTimeout: this.state.duration, __source: {
                            fileName: _jsxFileName,
                            lineNumber: 17
                        }
                    },
...
var Fade = _styledComponents2.default.div(_templateObject, function (props) {
    return props.duration;
}, function (props) {
    return props.duration;
}, function (props) {
...
var _Wiggle = __webpack_require__(95);

var _Wiggle2 = _interopRequireDefault(_Wiggle);

var _SlideSide = __webpack_require__(41);
...
var _Table = __webpack_require__(45);
...
var Settings = function (_React$Component) {
    ...
    _createClass(Settings, [{
        key: 'onInput',
        value: function onInput(id, value) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_Text2.default, { tag: 'p', text: 'Day/Night mode:', display: 'inline-block', padding: '5px 0px', colorKey: 'textInverted', __source: {
                                fileName: _jsxFileName,
                                lineNumber: 30
                            }
                        }),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(_index2.default, { id: DAYNIGHT, isChecked: this.props.daynight, onInput: this.onInput, __source: {
                                    fileName: _jsxFileName,
                                    lineNumber: 32
                                }
                            })
...
var _LogError = __webpack_require__(10);
...
var _ErrorBoundary = __webpack_require__(53);

var _ErrorBoundary2 = _interopRequireDefault(_ErrorBoundary);

var _MyValid = __webpack_require__(54);
...
var _apiReducer = __webpack_require__(20);
...
var _jsxFileName = '/home/pagevii/Documents/code/web/github/ss4/src/components/layout/Root.jsx';
...
var _reactStaticRoutes = __webpack_require__(61);

var _reactStaticRoutes2 = _interopRequireDefault(_reactStaticRoutes);

var _Analytics = __webpack_require__(109);

var _Analytics2 = _interopRequireDefault(_Analytics);

var _Gapi = __webpack_require__(112);
...
var _FadeIn = __webpack_require__(39);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        { theme: this.props.isDay ? _theme.day : _theme.night, __source: {
                                fileName: _jsxFileName,
                                lineNumber: 23
                            }
                        },
...
var Base = _styledComponents2.default.div(_templateObject3, function (props) {
    return props.theme.neutral;
});
    ...
    return _react2.default.createElement(_reactStatic.Route, {
        ...
        render: function render(props) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _FadeIn2.default,
                    { offset: 100, duration: 3000, childDelay: 150, __source: {
                            fileName: _jsxFileName,
                            lineNumber: 147
                        }
                    },
...
var t_1 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/pagevii/Documents/code/web/github/ss4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 29)), (0, _importCss3.default)('src/containers/Post.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_3 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/pagevii/Documents/code/web/github/ss4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 35)), (0, _importCss3.default)('src/containers/Games.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_4 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/pagevii/Documents/code/web/github/ss4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 37)), (0, _importCss3.default)('src/containers/Game.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_5 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/pagevii/Documents/code/web/github/ss4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 47)), (0, _importCss3.default)('src/containers/About.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_6 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/pagevii/Documents/code/web/github/ss4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 48)), (0, _importCss3.default)('src/containers/Settings.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_7 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/pagevii/Documents/code/web/github/ss4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 49)), (0, _importCss3.default)('src/containers/Privacy.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_8 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/home/pagevii/Documents/code/web/github/ss4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 50)), (0, _importCss3.default)('src/containers/404.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var Post = _styledComponents2.default.div(_templateObject2, function (props) {
  return props.theme.roundCorners;
}, function (props) {
  return props.theme.primary;
}, function (props) {
...
module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 70 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 71 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 72 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 73 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"
...
module.exports = "data:image/svg+xml;base64,"
    ...
    _createClass(Score, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Text2.default, { tag: 'h3', text: this.props.title, align: 'left', colorKey: 'primaryD', padding: '0', width: '100%', __source: {
                        fileName: _jsxFileName,
                        lineNumber: 30
                    }
                }),
                this.props.desc ? _react2.default.createElement(_Text2.default, { tag: 'p', text: this.props.desc, align: 'left', padding: '5px 0px', width: '100%', __source: {
                        fileName: _jsxFileName,
                        lineNumber: 31
                    }
                }) : null,
...
var ScoreBar = _styledComponents2.default.div(_templateObject2, function (props) {
...
var _Load = __webpack_require__(86);
...
var _GameMenu = __webpack_require__(100);
...
var _PersistStore = __webpack_require__(87);
...
var _fileUtils = __webpack_require__(96);

var _reactStatic = __webpack_require__(2);

var _localStorageUtils = __webpack_require__(97);
...
var _LoadGameView = __webpack_require__(98);
...
var _reduxPersist = __webpack_require__(88);

var _storage = __webpack_require__(89);

var _storage2 = _interopRequireDefault(_storage);

var _autoMergeLevel = __webpack_require__(90);
...
var _jsxFileName = '/home/pagevii/Documents/code/web/github/ss4/src/components/game/Submit.jsx';
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } //a modal that gets the course and assignment information
...
var Submit = function (_React$Component) {
    ...
    _createClass(Submit, [{
        ...
        value: function componentDidUpdate(prevProps) {
            ...
            var id1 = this.props.document ? this.props.document.id : null;
            var id2 = prevProps.document ? prevProps.document.id : null;
            if (id1 && id1 !== id2) {
                this.setState({
                    open: false
                });
        ...
        value: function submitAssignment(courseId, courseWorkId, submissionId) {
            ...
            try {
                if (!courseId) {
                    ...
                    results.courseWorkId = courseWorkId;
                    (0, _DriveInterface.createReport)('submit1', 'submitname', [{ tag: 'h1', text: 'Defered promise', textDecoration: 'underline', textAlign: 'center', fontStyle: 'bold' }]).then(function (r) {
                ...
                return this.state.courseWorks.map(function (c) {
                    return _react2.default.createElement(
                        ...
                        { onClick: function onClick() {
                                _this3.submitAssignment(c.courseId, c.id);
                            }, __source: {
                                fileName: _jsxFileName,
                                lineNumber: 92
                            }
...
var _SignInUi = __webpack_require__(101);

var _SignInUi2 = _interopRequireDefault(_SignInUi);

var _ClassShare = __webpack_require__(102);
...
var SignIn = function (_React$Component) {
    ...
    _createClass(SignIn, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { id: 'g-sharetoclassroom', onsharestart: 'myFnWeb', onShareStart: 'myFnWeb', 'data-onsharestart': 'myFnWeb', 'data-onShareStart': 'myFnWeb', __source: {
                        fileName: _jsxFileName,
                        lineNumber: 43
                    }
                },
...
var _rcSlider = __webpack_require__(107);
...
var _cookies = __webpack_require__(110);
...
exports.default = (0, _reactStatic.withSiteData)((0, _reactStatic.withRouteData)((0, _reactStatic.withRouter)(Menu)));
...
//# sourceMappingURL=static.6f50c161.js.map