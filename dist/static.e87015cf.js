...
var _d3Ease = __webpack_require__(22);
...
var Menu = function (_React$Component) {
    ...
    _createClass(Menu, [{
        ...
        value: function componentDidUpdate(prevProps, prevState) {
            console.log('MainMenu componentDidUpdate prev ' + prevProps.location.pathname + ' this ' + this.props.location.pathname);
        ...
        value: function renderDrop() {
            if (this.state.cat) {
                return _react2.default.createElement(
                    'div',
                    { style: { position: 'absolute', zIndex: '10', padding: '10px', backgroundColor: 'white' } },
                    this.state.categories.map(function (c) {
                        return _react2.default.createElement(
                            _reactStatic.Link,
                            { style: { display: 'inline-block' }, to: '/' + c },
...
var _TalkitGame = __webpack_require__(54);
...
var _Bg = __webpack_require__(55);
...
var _SlideUp = __webpack_require__(17);
...
var _FadeIn = __webpack_require__(57);
...
var _GameListItem = __webpack_require__(59);
            ...
            switch (game) {
                case 'samplegame':
                    return (0, _universalImport3.default)({
                        ...
                        load: function load() {
                            return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 19)), (0, _importCss3.default)('samplegame', {
                                disableWarnings: true
                            })]).then(function (proms) {
                                return proms[0];
                            });
...
var _Analytics = __webpack_require__(72);

var _Analytics2 = _interopRequireDefault(_Analytics);

var _Gapi = __webpack_require__(73);

var _Gapi2 = _interopRequireDefault(_Gapi);

var _d3Ease = __webpack_require__(22);

var _reactMove = __webpack_require__(74);
...
var _samplegame = __webpack_require__(19);
...
var _mygamelibs = __webpack_require__(65);
