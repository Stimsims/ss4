...
exports.expressions = exports.functions = exports.constants = undefined;
...
var expressions = exports.expressions = {
    'arithmeticSequence': {
        ...
        ex: 'a1+(n-1)d',
        exAlt: ['3*(x+1)^3+8*(x+1)^2+u', 'sin(x)/cos(x)', '(x+1)*cos(x+1)'],
        next: 'a(n-1)+d'
    }
...
var reducer = exports.reducer = function reducer() {
    ...
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (_ref = {}, _defineProperty(_ref, _Constants.constants.items.ship, (_constants$items$ship = {}, _defineProperty(_constants$items$ship, _Constants.constants.items.engine, {
        ...
        temp: _Constants.constants.elements.iron.shc,
        state: _Constants.constants.sim.engine.ok
    }), _constants$items$ship)), _defineProperty(_ref, _Constants.constants.items.asteroidSample, {}), _defineProperty(_ref, _Constants.constants.items.stock, {}), _defineProperty(_ref, _Constants.constants.items.sequence, {}), _ref);
    var action = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
var _reactAddonsCssTransitionGroup = __webpack_require__(58);
...
var _chartistPluginLegend = __webpack_require__(56);

var _chartistPluginLegend2 = _interopRequireDefault(_chartistPluginLegend);

var _chartistPluginAxistitle = __webpack_require__(57);
    ...
    function Dynamic(props) {
        ...
        var component = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
            ...
            resolve: function resolve() {
                return /*require.resolve*/(__webpack_require__(113).resolve("" + _this.props.payload));
            },
...
var _reactGa = __webpack_require__(63);
...
var _apiReducer = __webpack_require__(15);
...
var _Load = __webpack_require__(34);
...
var _PersistStore = __webpack_require__(35);
...
var _GameMenu = __webpack_require__(32);
...
var _reduxPersist = __webpack_require__(109);

var _storage = __webpack_require__(110);

var _storage2 = _interopRequireDefault(_storage);

var _autoMergeLevel = __webpack_require__(111);

var _autoMergeLevel2 = _interopRequireDefault(_autoMergeLevel);

var _react3 = __webpack_require__(112);
...
var _FadeIn = __webpack_require__(13);
...
var _randomizer = __webpack_require__(47);
...
var _gameReducer = __webpack_require__(103);

var _reducer = __webpack_require__(8);

var _reducer2 = __webpack_require__(11);

var _relationsReducer = __webpack_require__(104);

var _reducer3 = __webpack_require__(41);

var _parentReducer = __webpack_require__(105);
...
var t_0 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 55)), (0, _importCss3.default)('src/containers/Home', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_1 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: 'D:/websites/react-static/static-site-2/4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 59)), (0, _importCss3.default)('src/containers/Post', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_2 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: 'D:/websites/react-static/static-site-2/4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 60)), (0, _importCss3.default)('src/containers/Games', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_3 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: 'D:/websites/react-static/static-site-2/4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 68)), (0, _importCss3.default)('src/containers/Game', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var _PlayButtons = __webpack_require__(100);

var _PlayButtons2 = _interopRequireDefault(_PlayButtons);

var _InitializeGame = __webpack_require__(101);
...
var _Sequence = __webpack_require__(97);
...
var Lounge = exports.Lounge = function (_React$Component) {
    ...
    _createClass(Lounge, [{
        ...
        value: function onInput(input) {
            ...
            if (input[_Constants.constants.IO.kId] === I_ENTRY_1) {
                ...
                switch (this.props.fsm.state) {
                    case I_INVENTORY:
                    case I_SEQ:
                        if (input[_Constants.constants.IO.kId] === I_INVENTORY || input[_Constants.constants.IO.kId] === I_SEQ) {
                    ...
                    default:
                        ...
                        } else if (input[_Constants.constants.IO.kId] === I_SEQ) {
                            // console.log("dispatching inventory")
                            this.props.setFSMState(id, _defineProperty({}, _Constants.constants.fsm.keys.state, I_SEQ));
                        }
                        break;
                }
            }
        ...
        key: 'renderSequences',
        value: function renderSequences() {
            var _this2 = this;

            console.log("render sequences", this.props);
            return Object.keys(this.props.items.sequence).map(function (k, i) {
                var seq = _this2.props.factory(_Constants.constants.items.sequence);
                return _react2.default.createElement(seq.component, _extends({ showEntry: true, factory: _this2.props.factory, item: _this2.props.items.sequence[k],
                    onInput: _this2.onInput }, _Constants.functions.propKid(I_SEQ)));
            });
        }
    }, {
        key: 'renderView',
        value: function renderView() {
            ...
            if (this.props.showEntry) {
                ...
                switch (this.props.fsm.state) {
                    ...
                    case I_SEQ:
                        var seq = this.props.factory(_Constants.constants.items.sequence);
                        return _react2.default.createElement(seq.component, _extends({ showEntry: false, factory: this.props.factory,
                            onInput: this.onInput }, _Constants.functions.propKid(I_SEQ)));
                    case S_IN:
                    default:
...
var _asteroidSample = __webpack_require__(64);
...
var id = exports.id = _Constants.constants.items.sequence;
var S_IN = 'in',
    I_ENTRY_1 = 'e1',
    S_BACK = 'back';

var Seq = function (_React$Component) {
    _inherits(Seq, _React$Component);

    function Seq(props) {
        _classCallCheck(this, Seq);

        var _this = _possibleConstructorReturn(this, (Seq.__proto__ || Object.getPrototypeOf(Seq)).call(this, props));
    ...
    _createClass(Seq, [{
        ...
        value: function renderItem() {
            ...
            view.push(_react2.default.createElement(
                'p',
                null,
                'A detailed view of the sequence'
            ));
            return view;
        }
    }, {
...
var mapStateToProps = function mapStateToProps(state, props) {
    var fsm = (0, _selectors.selectFsmState)(state, _Constants.constants.items.sequence, _defineProperty({}, _Constants.constants.fsm.keys.state, S_IN));
    //Bug there is a state where the inventory is not passing an item in, and the asteroidSample
    //has not recieved a fresh store state, and thus has no item
    //this is resolved in ComponendWillUpdate, which passes in the fresh store state
    //will need to tolerate no item to display
...
var component = exports.component = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Seq);
exports.default = component;
...
var _Sequence = __webpack_require__(102);
...
var Initialize = function (_React$Component) {
    ...
    _createClass(Initialize, [{
        ...
        value: function componentDidMount() {
            ...
            var sequence = this.props.createSequence();
            this.props.addItem(_Constants.constants.fsm.zones.lounge, _Constants.constants.items.sequence, sequence.id, sequence);
        }
    }, {
        key: 'render',
        value: function render() {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return (0, _redux.bindActionCreators)({
        createSample: _asteroidSample.createSample, addItem: _reducer.addItem, deleteItem: _reducer.deleteItem, createSequence: _Sequence.create
    }, dispatch);
};
var mapStateToProps = function mapStateToProps(state) {
    return {
...
var create = exports.create = function create() {
    var vA1 = Math.floor(Math.random() * 20) - 10;
    var vD = Math.floor(Math.random() * 5) + 2;
    return {
        id: 'arithmetic',
        type: _Constants.constants.items.sequence,
        ex: _Constants.expressions.arithmeticSequence,
        sequence: 'arithmetic',
        a1: vA1,
        d: vD,
        terms: [vA1, vA1 + vD],
...
var map = {
	...
	"./apis/apiReducer": 15,
	"./apis/apiReducer.js": 15,
	"./constants": 19,
	"./constants.js": 19,
	"./game/Game": 30,
	"./game/Game.jsx": 30,
	"./game/GameMenu": 32,
	"./game/GameMenu.jsx": 32,
	"./game/Index": 33,
	"./game/Index.jsx": 33,
	"./game/Load": 34,
	"./game/Load.jsx": 34,
	"./game/PersistStore": 35,
	"./game/PersistStore.jsx": 35,
	"./game/Store": 36,
	"./game/Store.jsx": 36,
	"./game/Wrapper": 37,
	"./game/Wrapper.jsx": 37,
	"./game/notes.txt": 67,
	"./game/views/Choice": 42,
	"./game/views/Choice.jsx": 42,
	"./layout/MainMenu": 6,
...
//# sourceMappingURL=static.47662338.js.map