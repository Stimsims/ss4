...
var _SlideUp = __webpack_require__(6);
        ...
        value: function renderOpenButton() {
            ...
            if (this.state.open) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(_IconButton2.default, { icon: "arrow", color: 'red', onInput: function onInput() {
...
var _reactKatex = __webpack_require__(94);
    ...
    function Talkit(props) {
        ...
        if (_this.props.tree) {
            ...
            if (ids) {
                ...
                console.log("indi post has a game", _this.state);
        ...
        value: function playNodes(next) {
            ...
            if (next.type == 'Set') {
                ...
                var branch = next.branches.filter(function (b) {
                    ...
                    console.log('branch comparison ' + comparison + '  value ' + value + ', is ' + variable + ' cVal ' + cVal + ' in state?', _this2.state);
...
var _adapterParallel = __webpack_require__(89);
...
var _trends = __webpack_require__(91);
...
var _reactChartist = __webpack_require__(88);
...
var Dynamic = function (_React$Component) {
    ...
    function Dynamic(props) {
        ...
        var component = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
            ...
            load: function load() {
                return Promise.all([__webpack_require__(92)("" + _this.props.payload), (0, _importCss3.default)('' + _this.props.payload, {
...
var _SignInUi = __webpack_require__(31);
...
var _samplegame = __webpack_require__(43);
...
var _reduxPersist = __webpack_require__(97);

var _storage = __webpack_require__(98);

var _storage2 = _interopRequireDefault(_storage);

var _autoMergeLevel = __webpack_require__(99);

var _autoMergeLevel2 = _interopRequireDefault(_autoMergeLevel);

var _react3 = __webpack_require__(100);
...
var _PersistStore = __webpack_require__(36);
...
var _requireUniversalModule = __webpack_require__(79);
...
var _reportChunks = __webpack_require__(80);
...
var _GameListItem = __webpack_require__(37);
...
var _reducer2 = __webpack_require__(96);
            ...
            switch (game) {
                case 'samplegame':
                    return (0, _universalImport3.default)({
                        ...
                        load: function load() {
                            return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 43)), (0, _importCss3.default)('samplegame', {
                                disableWarnings: true
                            })]).then(function (proms) {
                                return proms[0];
                            });
...
var _reactHotLoader = __webpack_require__(76);

var _reactStaticRoutes = __webpack_require__(77);
...
var _Gapi = __webpack_require__(30);
...
var t_0 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 39)), (0, _importCss3.default)('src/containers/Post', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_1 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: 'D:/websites/react-static/static-site-2/4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 60)), (0, _importCss3.default)('src/containers/Posts.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_2 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: 'D:/websites/react-static/static-site-2/4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 39)), (0, _importCss3.default)('src/containers/Post.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_3 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: 'D:/websites/react-static/static-site-2/4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 61)), (0, _importCss3.default)('src/containers/Home.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_4 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: 'D:/websites/react-static/static-site-2/4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 64)), (0, _importCss3.default)('src/containers/Games', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_5 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: 'D:/websites/react-static/static-site-2/4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 71)), (0, _importCss3.default)('src/containers/Game', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_6 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: 'D:/websites/react-static/static-site-2/4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 72)), (0, _importCss3.default)('src/containers/About.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_7 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: 'D:/websites/react-static/static-site-2/4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 73)), (0, _importCss3.default)('src/containers/404.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var map = {
	...
	"./UI/animations/Rotate": 42,
	"./UI/animations/Rotate.jsx": 42,
	"./UI/animations/SlideUp": 6,
	"./UI/animations/SlideUp.jsx": 6,
	"./UI/animations/styles.css": 54,
	...
	"./UI/elements/Container": 8,
	"./UI/elements/Container.jsx": 8,
	"./UI/elements/IconButton": 7,
	"./UI/elements/IconButton.jsx": 7,
	...
	"./game/Game.jsx": 32,
	"./game/GameMenu": 33,
	"./game/GameMenu.jsx": 33,
	"./game/Index": 34,
	"./game/Index.jsx": 34,
	"./game/Load": 44,
	"./game/Load.jsx": 44,
	"./game/PersistStore": 36,
	"./game/PersistStore.jsx": 36,
	"./game/SampleGame": 45,
	"./game/SampleGame.jsx": 45,
	"./game/Store": 35,
	"./game/Store.jsx": 35,
	"./game/Wrapper": 46,
	"./game/Wrapper.jsx": 46,
	"./game/notes.txt": 70,
	"./game/views/Choice": 47,
