...
class Inventory extends React.Component{
    ...
    renderItems(){
        if(this.props.items[constants.items.asteroidSample]){
            let sample = this.props.factory(constants.items.asteroidSample);
            return (
                <div>
                    <sample.component items={this.props.items[constants.items.asteroidSample]} 
                    showEntry={true} factory={this.props.factory} onInput={this.onInput} kId={S_SAMPLE}/>
                </div>
            )
        }
        return null;
