...
var _baselineKeyboard_arrow_right24px = __webpack_require__(27);
    ...
    _createClass(Icon, [{
        ...
        value: function wrapButton(icon) {
            if (this.props.text) {
                ...
                return _react2.default.createElement(
                    'span',
                    { style: { display: 'inline-block', padding: '5px' }, __source: {
                            fileName: _jsxFileName,
                            lineNumber: 67
                        }
                    },
        ...
        value: function render() {
            ...
            if (this.props.disabled) {
                ...
                return this.wrapButton(_react2.default.createElement(
                    Btn,
                    (_React$createElement = { disabled: true, className: this.props.classes, padding: this.props.padding
                    }, _defineProperty(_React$createElement, 'disabled', true), _defineProperty(_React$createElement, 'onClick', this.props.onInput), _defineProperty(_React$createElement, 'round', this.props.round), _defineProperty(_React$createElement, '__source', {
                        fileName: _jsxFileName,
                        lineNumber: 74
...
var Label = _styledComponents2.default.p(_templateObject, function (props) {
    return props.theme[props.theme.theme].mediaMinWidth;
});
var TextBtn = _styledComponents2.default.button(_templateObject2, function (props) {
...
var Btn = _styledComponents2.default.button(_templateObject3, function (props) {
...
var _Slide = __webpack_require__(25);

var _Slide2 = _interopRequireDefault(_Slide);

var _PostItem = __webpack_require__(58);
...
var _Sizer = __webpack_require__(71);
...
var _Trends = __webpack_require__(73);
...
var _baselineVideogame_asset24px = __webpack_require__(30);
            ...
            switch (game) {
                case 'samplegame':
                    return (0, _universalImport3.default)({
                        ...
                        load: function load() {
                            return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 37)), (0, _importCss3.default)('samplegame', {
                ...
                case 'fairyjoules':
                    return (0, _universalImport3.default)({
                        ...
                        file: 'D:/websites/react-static/static-site-2/4/src/containers/Game.jsx',
                        load: function load() {
                            return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 38)), (0, _importCss3.default)('fairyjoules', {
                                disableWarnings: true
                            })]).then(function (proms) {
                                return proms[0];
                            });
                ...
                case 'labgame':
                    return (0, _universalImport3.default)({
                        ...
                        file: 'D:/websites/react-static/static-site-2/4/src/containers/Game.jsx',
                        load: function load() {
                            return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 39)), (0, _importCss3.default)('labgame', {
                                disableWarnings: true
                            })]).then(function (proms) {
                                return proms[0];
                            });
...
var _mygamelibs = __webpack_require__(90);
    ...
    _createClass(Game, [{
        ...
        value: function importNerdamer() {
            ...
            (0, _universalImport3.default)({
                ...
                load: function load() {
                    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 33)), (0, _importCss3.default)('nerdamer/all', {
                        disableWarnings: true
                    })]).then(function (proms) {
                        return proms[0];
                    });
                ...
                path: function path() {
                    return _path3.default.join(__dirname, 'nerdamer/all');
                },
                resolve: function resolve() {
...
module.exports = require("fairyjoules");

/***/ }),
/* 39 */
/***/ (function(module, exports) {

module.exports = require("labgame");
...
var _ErrorBoundary = __webpack_require__(48);

var _ErrorBoundary2 = _interopRequireDefault(_ErrorBoundary);

var _MyValid = __webpack_require__(49);
...
var _reactStaticRoutes = __webpack_require__(52);
...
var _Analytics = __webpack_require__(104);

var _Analytics2 = _interopRequireDefault(_Analytics);

var _Gapi = __webpack_require__(109);

var _Gapi2 = _interopRequireDefault(_Gapi);

var _recompose = __webpack_require__(110);
...
var _FadeIn = __webpack_require__(113);
...
var t_0 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 22)), (0, _importCss3.default)('src/containers/Posts.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_1 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: 'D:/websites/react-static/static-site-2/4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 26)), (0, _importCss3.default)('src/containers/Post.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_3 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: 'D:/websites/react-static/static-site-2/4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 29)), (0, _importCss3.default)('src/containers/Games.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_4 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: 'D:/websites/react-static/static-site-2/4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 31)), (0, _importCss3.default)('src/containers/Game.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_5 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: 'D:/websites/react-static/static-site-2/4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 40)), (0, _importCss3.default)('src/containers/About.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_6 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: 'D:/websites/react-static/static-site-2/4/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 41)), (0, _importCss3.default)('src/containers/Settings.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var _trends = __webpack_require__(74);
...
var _NodeGroup = __webpack_require__(77);

var _NodeGroup2 = _interopRequireDefault(_NodeGroup);

var _d3Ease = __webpack_require__(78);
  ...
  _createClass(Index, [{
    ...
    value: function renderPersistStore() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _Load2.default,
          { id: this.props.id, reducers: this.state.reducers, registerMenuItem: this.registerMenuItem, __source: {
              fileName: _jsxFileName,
              lineNumber: 87
            }
          },
          _react2.default.createElement(_Game2.default, _extends({ game: this.state.game }, this.state.settings, {
            __source: {
              fileName: _jsxFileName,
              lineNumber: 88
            }
...
var _PersistStore = __webpack_require__(81);

var _PersistStore2 = _interopRequireDefault(_PersistStore);

var _fileUtils = __webpack_require__(86);

var _reactStatic = __webpack_require__(2);

var _localStorageUtils = __webpack_require__(87);

var _reactRedux = __webpack_require__(4);

var _DriveInterface = __webpack_require__(88);

var _IconButton = __webpack_require__(9);

var _IconButton2 = _interopRequireDefault(_IconButton);

var _LoadGameView = __webpack_require__(89);
...
var Load = function (_React$Component) {
    ...
    _createClass(Load, [{
        ...
        value: function uploadFile(driveId, fileId) {
            ...
            var filename = getStoreName(this.props, fileId);
        ...
        value: function registerMenuButtons(fileId) {
            ...
            if (fileId) {
                this.props.registerMenuItem([{
                    ...
                    id: 'none',
                    position: 'right',
                    component: _react2.default.createElement(_IconButton2.default, { className: 'no-fileId', key: 'none', text: 'sync', round: true, icon: 'sync', disabled: true, __source: {
                            fileName: _jsxFileName,
                            lineNumber: 289
                        }
                    })
                    ...
                    key: 'cloud',
                    position: 'right',
                    component: _react2.default.createElement(_IconButton2.default, { key: 'cloud', round: true, icon: 'cloud', text: 'upload', onInput: function onInput() {
                ...
                this.props.registerMenuItem([{
                    ...
                    id: fileId,
                    position: 'right',
                    component: _react2.default.createElement(_IconButton2.default, { className: 'fileId', key: fileId, round: true, text: 'sync', icon: 'sync', onInput: function onInput() {
                            //console.log('load sync save button clicked! ' + fileId);
                    ...
                    key: 'cloud',
                    position: 'right',
                    component: _react2.default.createElement(_IconButton2.default, { key: 'cloud', round: true, icon: 'cloud', text: 'upload', disabled: true, __source: {
                            fileName: _jsxFileName,
                            lineNumber: 324
                        }
                    })
...
var _reduxPersist = __webpack_require__(82);

var _storage = __webpack_require__(83);

var _storage2 = _interopRequireDefault(_storage);

var _autoMergeLevel = __webpack_require__(84);

var _autoMergeLevel2 = _interopRequireDefault(_autoMergeLevel);

var _react3 = __webpack_require__(85);
...
var _jsxFileName = 'D:\\websites\\react-static\\static-site-2\\4\\src\\components\\game\\Settings.jsx';
...
var _SettingsReducer = __webpack_require__(36);
...
var Settings = function (_React$Component) {
    ...
    function Settings(props) {
        ...
        props.registerMenuItem([{
            key: 'settings',
            position: 'right',
            component: _react2.default.createElement(_IconButton2.default, { round: true, icon: 'settings', text: 'settings', onInput: function onInput() {
                    _this.setState({
                        open: true
                    });
                }, __source: {
            ...
            if (this.state.open) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_IconButton2.default, { icon: 'back', round: true, onInput: this.onClose, __source: {
                                fileName: _jsxFileName,
                                lineNumber: 126
                            }
                        }),
...
var _jsxFileName = 'D:\\websites\\react-static\\static-site-2\\4\\src\\components\\UI\\elements\\Checkbox\\index.jsx';
...
var _jsxFileName = 'D:\\websites\\react-static\\static-site-2\\4\\src\\components\\UI\\elements\\Slider\\index.jsx';
...
var _cookies = __webpack_require__(105);
...
var _Wiggle = __webpack_require__(107);
...
//# sourceMappingURL=static.48f77147.js.map